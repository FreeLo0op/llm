...
data_lists = open(r'/mnt/cfs/SPEECH/hupeng/github/llm_pp/datas/hp_data/zijie_120w_tts_json.list','r',encoding='utf8').readlines()
#data_lists = list(Path("/mnt/cfs/SPEECH/liuhuang1/workspace/tts_frontend/tts-frontend-dataset/scripts/wenkai5_text/").glob("**/*.json"))
data_lists = sorted(data_lists)
with open("/mnt/cfs/SPEECH/hupeng/github/llm_pp/datas/hp_data/zijie_120w.txt", "w", encoding="utf8") as wf:
  i = 1
  for item in tqdm(data_lists):
    ...
    try:
      ...
      # change #4 to #3 ori ''
      prosody_text = re.sub(r'#4', r'#3', prosody_text)
      # Mrs.#1 dr.#1
